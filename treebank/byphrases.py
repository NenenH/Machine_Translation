...
def parse_word_tag(word, tag, sentence):
    rule_perphrase_a = """S ->  DP | VP | NP | PP | AP | VP | CP 
    ...
    grammar = CFG.fromstring(rule_perphrase_a + sentence_word_tag)
...
for toStem in rules:
    ...
    phrases_notstemmed = phrase(toStem)
    ...
    print('phrases: ')
    print(phrases)
    print('phrases not stemmed: ')
    print(phrases)

    for ph_notstemmed in phrases_notstemmed:
        get_sentence(ph_notstemmed)
    print('\n')
